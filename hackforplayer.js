...
/***/ function(module, exports, __webpack_require__) {
	...
	const makeIFrame = __webpack_require__(32);
	const makeEditor = __webpack_require__(34);
	const stayBottom = __webpack_require__(41);
	const Button = __webpack_require__(42);

	const src = 'http://localhost:3000/index.html';

	const init = (namespace) => {
	  const selectors = __webpack_require__(31)(namespace);
	...
	h4p.trigger = __webpack_require__(43)('h4p').trigger;
...
/***/ function(module, exports, __webpack_require__) {
	...
	const erd = __webpack_require__(6)({
	  strategy: "scroll" //<- For ultra performance.
	});
	const raf = __webpack_require__(19);

	const getElementRect = __webpack_require__(22);
	const content = __webpack_require__(23).content;
	const button = __webpack_require__(23).button;
	const editor = __webpack_require__(23).editor;
	...
	class Player extends EventTarget {
	  ...
	  constructor(props) {
	    ...
	    this.selectors = __webpack_require__(31)(props.namespace);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var elementUtilsMaker       = __webpack_require__(8);
	var listenerHandlerMaker    = __webpack_require__(9);
	var idGeneratorMaker        = __webpack_require__(10);
	var idHandlerMaker          = __webpack_require__(11);
	var reporterMaker           = __webpack_require__(12);
	var browserDetector         = __webpack_require__(13);
	var batchProcessorMaker     = __webpack_require__(14);
	var stateHandler            = __webpack_require__(16);

	//Detection strategies.
	var objectStrategyMaker     = __webpack_require__(17);
	var scrollStrategyMaker     = __webpack_require__(18);
...
/***/ function(module, exports, __webpack_require__) {
	...
	const Hogan = __webpack_require__(24);

	module.exports = {
	  content: new Hogan.Template(__webpack_require__(27)),
	  button: new Hogan.Template(__webpack_require__(28)),
	  editor: new Hogan.Template(__webpack_require__(29)),
	  copyright: new Hogan.Template(__webpack_require__(30))
	};
...
/***/ function(module, exports) {
	...
	module.exports = {code: function (c,p,i) { var t=this;t.b(i=i||"");t.b("<div");t.b("\n" + i);t.b("  class=\"h4p__panel\"");t.b("\n" + i);t.b("  style=\"position: fixed; width: 50vw; height: 100vh; top: 0; right: 0; background-color: gray; display: flex; visibility: ");t.b(t.v(t.d("panel.visibility",c,p,0)));t.b("\"");t.b("\n" + i);t.b(">");t.b("\n" + i);t.b("  <div");t.b("\n" + i);t.b("    class=\"h4p__sizer\"");t.b("\n" + i);t.b("    style=\"width: 1px; height: 100%; background-color: blue; \"");t.b("\n" + i);t.b("  ></div>");t.b("\n" + i);t.b("  <div");t.b("\n" + i);t.b("    class=\"h4p__editor_container\"");t.b("\n" + i);t.b("    style=\"display: flex; flex-direction: column; justify-content: stretch; flex: 1 1 auto; background-color: green; \"");t.b("\n" + i);t.b("  >");t.b("\n" + i);t.b("    <div class=\"h4p__editor_menu\">");t.b("\n" + i);t.b("      <button type=\"button\" name=\"button\">button</button>");t.b("\n" + i);t.b("      <button type=\"button\" name=\"button\">button</button>");t.b("\n" + i);t.b("      <button type=\"button\" name=\"button\">button</button>");t.b("\n" + i);t.b("    </div>");t.b("\n" + i);t.b("    <div class=\"h4p__editor\" style=\"flex: 1 1 auto;\"></div>");t.b("\n" + i);t.b("  </div>");t.b("\n" + i);t.b("</div>");t.b("\n");return t.fl(); },partials: {}, subs: {  }}
...
/***/ function(module, exports, __webpack_require__) {
	...
	const initPosition = __webpack_require__(33);
...
/***/ function(module, exports, __webpack_require__) {
	...
	const on = __webpack_require__(43)('h4p').on;
